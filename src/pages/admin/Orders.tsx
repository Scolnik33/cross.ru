...
import {
  Search, Filter, Eye, ChevronDown, ArrowUpDown,
        ...
        <div className="bg-dark-card rounded-lg p-4 mb-6">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="relative">
              ...
              >
                {statusFilter ? `Статус: ${getStatusLabel(statusFilter)}` : 'Фильтр по статусу'}
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-dark-border">
              ...
              {displayedOrders.map((order) => (
                  <tr key={order.id} className="hover:bg-dark-surface">
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-light-muted">
                  Показано с <span className="font-medium">{(currentPage - 1) * itemsPerPage + 1}</span> по{' '}
                  <span className="font-medium">
                  {Math.min(currentPage * itemsPerPage, filteredOrders.length)}
                </span>{' '}
                  из <span className="font-medium">{filteredOrders.length}</span> результатов
                </p>
              </div>
              <div>
