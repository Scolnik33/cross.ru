  ...
  return (
    <div>
      ...
      <section 
        ...
        style={{ 
          backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.7)), url(https://sun9-6.userapi.com/impg/Y7OXeUXcR8QYTh6Ko2t6ykHX6sHbfc1Txgx-dA/bAxtbwkH6m0.jpg?size=950x950&quality=95&sign=171daacc0878eab6d15fa5dd81b3d4e2&type=album)',
      ...
      <section className="py-16 bg-dark-surface">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Почему выбирают нас</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-dark-card p-6 rounded-lg text-center transition-transform hover:transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Отвечаем за качество</h3>
              <p className="text-light-muted">
                Наша обувь изготовлена из лучших материалов, обеспечивающих долговечность и комфорт.
              </p>
            </div>
            ...
            <div className="bg-dark-card p-6 rounded-lg text-center transition-transform hover:transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Быстрая доставка</h3>
              <p className="text-light-muted">
                Быстрая доставка позволит вам получить новую обувь как можно скорее.
              </p>
            </div>
            ...
            <div className="bg-dark-card p-6 rounded-lg text-center transition-transform hover:transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Безопасная оплата</h3>
              <p className="text-light-muted">
      ...
      <section className="py-16 bg-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Будьте в курсе событий</h2>
            <p className="text-light-muted mb-8">
              Подпишитесь на нашу рассылку, чтобы получать эксклюзивные предложения, новые поступления и скидки.
            </p>
            ...
            <p className="text-sm text-light-muted mt-4">
              Подписываясь, вы соглашаетесь с нашей Политикой конфиденциальности и даете согласие на получение обновлений от CROSS.RU.
            </p>
          </div>
        </div>
      </section>
